...
assertTrue(navigation.listUrl("A B") === "index.aspx?codeClass=A%20B", "builds encoded list URLs");
assertTrue(navigation.detailUrl("ORG_SUB_TY_CD", "CORP", 42) === "index.aspx?codeClass=ORG_SUB_TY_CD&codeValue=CORP&id=42", "builds approved detail URLs");
